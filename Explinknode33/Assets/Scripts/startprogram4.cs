...
public class startprogram4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (Clickcount == 5)
        {
            ...
            InputAdress1.enabled = true;
            memorystartref_.showNextAddress(memorystartref_.adcount[1]);
            if (pAddressInputEditref_.StrAddress == memorystartref_.NextAdress.ToLower())
            {
                flagadress = true;
                ErrorImage1.enabled = false;
